...
- Experience: Currently an intern with strong foundation
- Specialties: AI/ML, Python, Data Analysis, No-Code Development, Workflow Automation
- Notable project: AI Workflow Automation Systems
- Other projects: Enterprise Micro-Architecture Portal, Predictive Engagement Engine
- Languages: English (fluent), Hindi
- Hobbies: Coding, building AI projects, automation
...
3. If asked about work/projects, share your genuine experiences based on the profile
4. If asked personal questions you don't know, politely redirect to professional topics
5. Keep responses concise but helpful
6. You can discuss AI, programming, tech, or anything related to your field
...
const Play = () => {
    ...
    const [chatMessages, setChatMessages] = useState([
        { role: 'assistant', content: `Hello there! I am ${config.developer.name} 👋 Ask me anything you want to know!` }
    ]);
    ...
    const renderCapturedPieces = (pieces, color) => {
        return pieces.map((piece, index) => {
            ...
            const svg = PIECES[key];
            return (<div key={index} className="captured-piece" dangerouslySetInnerHTML={{ __html: svg || '' }}/>);
        });
    };
      ...
      <div className="chess-container">
        ...
        <div className="chat-panel">
          ...
          <div className="chat-messages">
            {chatMessages.map((msg, index) => (<div key={index} className={`chat-message ${msg.role}`}>
                <div className="message-content">{msg.content}</div>
              </div>))}
            {isTyping && (<div className="chat-message assistant">
          ...
          <div className="chat-input-area">
            <input type="text" className="chat-input" placeholder="Type a message..." value={chatInput} onChange={(e) => setChatInput(e.target.value)} onKeyPress={handleKeyPress} data-cursor="disable"/>
        ...
        <div className="chess-board-section">
          ...
          <div className="chess-board-wrapper">
            ...
            return (<div key={square} className={`chess-square ${isLight ? 'light' : 'dark'} 
                        ${isSelected ? 'selected' : ''} 
                        ${isLastMoveSquare ? 'last-move' : ''}
                        ${isCheck ? 'in-check' : ''}`} onClick={() => handleSquareClick(square)} data-cursor="disable">
                      {/* Coordinate labels */}
        ...
        <div className="chess-side-panel right-panel">
          ...
          <div className="move-history">
            ...
            <div className="move-history-list">
              {formatMoveHistory().map((move, index) => (<div key={index} className="move-row">
